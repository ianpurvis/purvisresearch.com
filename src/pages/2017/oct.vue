...
const canonicalUrl = `${org.url}/2017/oct.html`
const title = 'Oct 2017: A Bézier Moiré Generator in WebGL | Purvis Research'
const description = 'A bézier moiré generator in WebGL.'
