...
const canonicalUrl = `${org.url}/2019/apr.html`
const title = 'Apr 2019: Surreal Television With WebRTC and WebGL | Purvis Research'
const description = 'Surreal television with WebRTC and WebGL.'
