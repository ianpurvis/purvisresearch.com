...
class Stack extends cdk.Stack {
  ...
  constructor(scope, id, props = {}) {
    ...
    this.redirectCertificate =
      new certificateManager.DnsValidatedCertificate(this, 'RedirectCertificate', {
    ...
    this.redirectDistribution =
      new cloudfront.CloudFrontWebDistribution(this, 'RedirectDistribution', {
        aliasConfiguration: {
          acmCertRef: this.certificate.certificateArn,
          names: [
            this.redirectCertificate.domainName
          ],
          securityPolicy: cloudfront.SecurityPolicyProtocol.TLS_V1_1_2016
        },
        defaultRootObject: '',
    ...
    this.hostedZoneRedirectA =
      new route53.ARecord(this, 'RedirectAliasRecord', {
        recordName: this.redirectCertificate.domainName,
        target: route53.RecordTarget.fromAlias(
